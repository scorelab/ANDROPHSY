...
public class QuickView extends Composite {
	...
	public QuickView(Composite parent, int style) {
		...
		tbtUrlSearch.setText("lk.score.androphsy.main.Search Pattern");
	...
	public static void populateData() {
		...
		ccnStat.generateStatistics("Credit Card", AndrospyMain.gb_CasePath +
		                                          "Analysis/Quick_Extract/ccn_histogram.txt");

		teleoffset.showDataExtracts(AndrospyMain.gb_CasePath +
		                            "Analysis/Quick_Extract/telephone.txt");
		TeleStat.generateStatistics("Telephone Numbers", AndrospyMain.gb_CasePath +
		                                                 "Analysis/Quick_Extract/telephone_histogram.txt");

		emailoffset.showDataExtracts(AndrospyMain.gb_CasePath + "Analysis/Quick_Extract/email.txt");
		emailStat.generateStatistics("Email Adress", AndrospyMain.gb_CasePath +
		                                             "Analysis/Quick_Extract/email_histogram.txt");

		domainStat.generateStatistics("Domain Summary", AndrospyMain.gb_CasePath +
		                                                "Analysis/Quick_Extract/domain_histogram.txt");
		emailDomainStat.generateStatistics("Email Domain", AndrospyMain.gb_CasePath +
		                                                   "Analysis/Quick_Extract/email_domain_histogram.txt");

		urlAllStat.generateStatistics("URL Summary", AndrospyMain.gb_CasePath +
		                                             "Analysis/Quick_Extract/url_histogram.txt");
		fbidstat.generateStatistics("Facebook Profile ID", AndrospyMain.gb_CasePath +
		                                                   "Analysis/Quick_Extract/url_facebook-id.txt");
		fbaddressstat.generateStatistics("Facebook Address", AndrospyMain.gb_CasePath +
		                                                     "Analysis/Quick_Extract/url_facebook-address.txt");
		urlsearchStat.generateStatistics("Searched URL", AndrospyMain.gb_CasePath +
		                                                 "Analysis/Quick_Extract/url_searches.txt");

		macoffset.showDataExtracts(AndrospyMain.gb_CasePath + "Analysis/Quick_Extract/ether.txt");
		macstat.generateStatistics("MAC Address", AndrospyMain.gb_CasePath +
		                                          "Analysis/Quick_Extract/ether_histogram.txt");

		ipoffset.showDataExtracts(AndrospyMain.gb_CasePath + "Analysis/Quick_Extract/ip.txt");
		ipstat.generateStatistics("MAC Address", AndrospyMain.gb_CasePath +
		                                         "Analysis/Quick_Extract/ip_histogram.txt");
