...
public class DataCollection extends Composite {
	...
	public DataCollection(Composite parent, int style) {
		...
		lblDataColletionPanel.setLayoutData(new GridData(SWT.CENTER, SWT.FILL, false, false, 7, 1));
		...
		GridData gd_btnConnectDeviceAnd = new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1);
		...
		lblArrow2.setLayoutData(new GridData(SWT.CENTER, SWT.CENTER, false, false));
		lblArrow2.setText(">>");
		lblArrow2.setFont(SWTResourceManager.getFont("Ubuntu", 20, SWT.NORMAL));

		btnRoot = new Button(this, SWT.WRAP);
		btnRoot.setEnabled(false);
		btnRoot.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 1, 1));
		btnRoot.setText("lk.score.androphsy.main.Root Device");
		...
		lblArrow1.setLayoutData(new GridData(SWT.CENTER, SWT.CENTER, false, false));
		...
		GridData gd_btnCollectRawData = new GridData(SWT.FILL, SWT.FILL, false, false);
		...
		GridData gd_btnRestoreDevice = new GridData(SWT.FILL, SWT.FILL, false, false);
		...
		lblConsole.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 2, 1));

		composite = new Composite(this, SWT.NONE);
		composite.setLayout(stacklayout);
		composite.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 5, 1));
		...
		GridData gd_composite_1 = new GridData(SWT.FILL, SWT.FILL, false, false, 7, 1);
			...
			if (!adbcmd.getDeviceBasicInfo(devicetemplate)) {
				...
				msg +=
				       "\n" + "Model:\t" + devicetemplate.getModel() + "\n" + "Manufacturer:\t" +
				               devicetemplate.getManufacturer() + "\n\n";
				/*
