...
public class Androspy extends Composite {
	...
	public Androspy(Composite parent, int arg1, String role) {
		...
		tabSearch.setText("lk.score.androphsy.main.Search and Filter");
		...
		tbtmAndroLog.setText("lk.score.androphsy.main.Androspy Log");
	...
	public void populateUserProfile(String fname, String lname, String email, String uname,
	                                String pic, int role) {
