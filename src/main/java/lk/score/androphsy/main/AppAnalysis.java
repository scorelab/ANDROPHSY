...
public class AppAnalysis extends Composite {
	...
	public AppAnalysis(Composite parent, int style) {
				...
				if (btnModel != null) {
					...
					if (((Button) arg0.widget).getSelection()) {
						if (sModel == "User Credentials") {
							AppDummyTab cmpDummyTab = new AppDummyTab(cmbBase, SWT.NONE);
		...
		lblApplicationAnalysis.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
		lblApplicationAnalysis.setText("Basic Application Analysis");

		Button btnPhoneBook = new Button(composite, SWT.RADIO);
		GridData gd_btnPhoneBook = new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1);
		...
		lblSocialNwAnalysis.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
		...
		lblBrowserArtifacts.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
		...
		lblLogAnalysis.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
		...
		lblWirelessNetworkAnalysis.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false,
		                                                      1, 1));
	...
	protected void PopulateData(String sModel) {
		try {
			...
			if (sModel == "Browser History") {
				...
				query =
				        "SELECT id, case_id, device_id, title AS Title, url AS URL, "
