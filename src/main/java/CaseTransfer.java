...
public class CaseTransfer extends Composite {
	...
	public CaseTransfer(Composite parent, int style) {
		...
		lblCaseId.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false,
				1, 1));
		lblCaseId.setText("Case ID");

		txtCaseId = new Text(this, SWT.BORDER);
		txtCaseId.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false,
				2, 1));

		Button btnsearch = new Button(this, SWT.NONE);
		btnsearch.setLayoutData(new GridData(SWT.FILL, SWT.FILL,
				false, false, 1, 1));
		...
		lblCaseName.setLayoutData(new GridData(SWT.LEFT, SWT.FILL, false,
				false, 1, 1));
		lblCaseName.setText("Case Name");
		lblCaseName.setBounds(8, 10, 93, 17);

		txtCaseName = new Text(this, SWT.BORDER);
		txtCaseName.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false,
				false, 2, 1));
		...
		txtCaseDesc.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false,
				false, 3, 3));
		...
		GridData gd_lblCasePath = new GridData(SWT.FILL, SWT.FILL, false,
				false, 1, 1);
		...
		GridData gd_lblInvId = new GridData(SWT.FILL, SWT.FILL, false, false,
				1, 1);
		...
		txtInvId.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false,
				1, 1));

		Label lblTransferTo = new Label(this, SWT.NONE);
		lblTransferTo.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false,
				false, 1, 1));
		lblTransferTo.setText("Transfer To:");

		txtNewInv = new Text(this, SWT.BORDER);
		txtNewInv.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false,
				1, 1));

		Label lblAnalystId = new Label(this, SWT.NONE);
		GridData gd_lblAnalystId = new GridData(SWT.FILL, SWT.FILL, false,
				false, 1, 1);
		...
		txtAnalystId.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false,
				false, 1, 1));
		...
		txtNewAnalyst.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true,
				false, 1, 1));
		new Label(this, SWT.NONE);
		new Label(this, SWT.NONE);
		new Label(this, SWT.NONE);
	...
	protected void SearchCase(int caseid) {
		try {
			...
			String query = "SELECT * FROM Androspy_Case WHERE case_id = "
					+ caseid;
			...
			while (rs.next()) {
				...
				txtAnalystId
						.setText(rs.getString("analyst_id").equals("null") ? ""
