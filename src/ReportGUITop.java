...
public class ReportGUITop extends Composite {
	...
	public ReportGUITop(Composite parent, int style) {
		...
		btnMap.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false, false,
				2, 1));
		...
		lblSocialNetworkingApplications.setLayoutData(new GridData(SWT.LEFT,
				SWT.CENTER, false, false, 3, 1));
		lblSocialNetworkingApplications
				.setText("Social Networking Applications");
		...
		btnFacebookDlg.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent arg0) {
				ExtractOptiondlg optiondlg = new ExtractOptiondlg(getShell(),
						SWT.NONE, "FACEBOOK", checked);
				optiondlg.open();
		...
		lblBrowserArtifacts.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER,
				false, false, 2, 1));
		...
		btnDefaultBrowser.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER,
				false, false, 2, 1));
		...
		btnGoogleChrome.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false,
				false, 2, 1));
		...
		btnFirefox.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false, false,
				2, 1));
		...
		btnBluetoothData.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER,
				false, false, 2, 2));
		...
		btnWifiPasswordswpapskwep.setLayoutData(new GridData(SWT.LEFT,
		...
		btnGenerateReport.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false,
				false, 1, 1));
		...
		grpRepportSections.setLayoutData(new GridData(SWT.FILL, SWT.FILL,
				false, true, 2, 1));
		...
		GridData gd_btnDeviceBasicInformation = new GridData(SWT.LEFT,
		...
		btnUp.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false,
				1, 1));
		...
		btnDown.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false,
				1, 1));
